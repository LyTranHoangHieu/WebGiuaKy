...
<!-- jquery-validation -->
<script src="/templates/admin/plugins/jquery-validation/jquery.validate.min.js"></script>
<script src="/templates/admin/plugins/jquery-validation/additional-methods.min.js"></script>
